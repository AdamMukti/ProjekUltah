let nama, val;
// Swal.fire(`Your IP address is ${nama}`)
            ...
            Swal.fire("Awas aja kalo boong!!", "", "error").then(function () {
                ...
                const {
                    ...
                    const pertanyaan = Swal.fire({
                        title: `${nama} sayang ga sama adam?`,
                        showDenyButton: true,
                        ...
                        if (result.isConfirmed) {
                            Swal.fire('Aku juga sayang banget sama kamu').then(function () {
                                Swal.fire({
                                    ...
                                    val = e.value
                                    Swal.fire(`Makasih ya udah sayang sama adam ${val}%`).then(function () {
                                        Swal.fire({
                                            ...
                                            /* Read more about isConfirmed, isDenied below */
                                            if (result.isConfirmed) {
                                                Swal.fire('Huhu iya aku juga kangen kamu :((').then(function () {
                                                    Swal.fire('Terakhir deh sayang').then(function () {
                                                        Swal.fire('Coba klik ikon hati di paling bawah dong')
                                                    })
                                                })
                                            } else if (result.isDenied) {
                                                Swal.fire('Jahat banget emang ga kangen sama pacar sendiri', '', 'error')
                                            }
                                        })
                                    })
                                })
                            ...
                            Swal.fire('Yakin ga suka sama adam?', '', 'error')
                        }
                    })
                })
            });
